...
### 实名认证还要收费？
因为第三方接口要收费，同时也避免被恶意利用封装成免费接口。选择“开通会员免费实名”选项时，实名认证无需额外付费，只需支付一个月会员费。
...
- 实名认证为消耗性资源，每次认证均会产生成本费用，故在返回认证结果后不支持退款。
- 支付渠道的投诉反馈并非pushplus的问题处理渠道，请勿使用，以免浪费时间。
- 多次恶意投诉，可能会触发程序的安全机制，导致账号不可用等情况出现。
