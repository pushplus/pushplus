...
| 插件渠道请求次数 | 0次 | 1,000次 | 10,000次
| App渠道请求次数 | 0次 | 200次 | 2,000次
| 微信ClawBot渠道请求次数 | 0次 | 1,000次 | 10,000次
| QQ机器人渠道日请求次数 | 0次 | 200次 | 1,000次
| 可创建群组数 | 5个 | 5个 |  50个
...
- 微信和邮件渠道推送超额后会对账号有限制，具体查看[发送消息接口有什么限制吗](../help/limit.md)。其他渠道超额后当日将无法推送。 
