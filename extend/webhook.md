...
![webhook渠道配置](../images/webhook.png)

| 显示名称 | 接口参数名称 | 说明 |
| -- | -- | --|
| Webhook名称 |  webhookName | 自定义名称，方便用户自己区分不同的配置 |
| Webhook编码 | webhookCode |  发消息接口的option参数填写此值 |
...
| --| --| --|
| 企业微信机器人 | https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key={自己的值}  | [pushplus推送到企业微信机器人教程](cpbot.md) |
| 钉钉机器人 | https://oapi.dingtalk.com/robot/send?access_token={自己的值} | [pushplus推送到钉钉机器人教程](dingding.md) |
| 飞书机器人 | https://open.feishu.cn/open-apis/bot/v2/hook/{自己的值} | [pushplus推送到飞书机器人教程](feishu.md) | 
| bark | https://api.day.app/{自己的值}| 暂无|
| Gotify | https://{自建服务器地址}/message?token={自己的值} | 暂无|
| 腾讯轻联 | 腾讯轻联webhook组件生成的地址 | [通过腾讯轻联实现发送短信](hiflow.md) |
| 集简云 | https://hook.jijyun.cn/v1/accept/data/webhook_accept_first?apikey={自己的值} | [通过集简云发送企业微信应用消息](jijyun.md) |
| IFTTT | https://maker.ifttt.com/use/{自己的值} | [调用IFTTT的webhook触发器教程](ifttt.md) |
| Server酱 | https://sctapi.ftqq.com/{自己的值}.send | 暂无 |
| WxPusher | https://wxpusher.zjiecode.com/api/send/message/?appToken={自己的值} | 暂无 |
| 自定义 | 自己的值 | [自定义webhook配置](diy.md) |
